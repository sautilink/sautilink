...
const SW = Object.freeze({
  ...
  'Loading the latest posts…': 'Inapakia posti mpya…',
  'Loading posts from people you follow…': 'Inapakia posti za watu unaowafuata…',
  'Loading short videos…': 'Inapakia video fupi…',
  'No posts yet.': 'Bado hakuna posti.',
  'Your Following feed is quiet.': 'Feed ya watu unaowafuata iko kimya.',
  'No short videos yet.': 'Bado hakuna video fupi.',
  'New posts from across SautiLink will appear here.': 'Posti mpya kutoka SautiLink zitaonekana hapa.',
...
const FR = Object.freeze({
  ...
  'Loading the latest posts…': 'Chargement des publications récentes…',
  'Loading posts from people you follow…': 'Chargement des publications des personnes suivies…',
  'Loading short videos…': 'Chargement des vidéos courtes…',
  ...
  'New posts from across SautiLink will appear here.': 'Les nouvelles publications de SautiLink apparaîtront ici.',
...
const USER_CONTENT_SELECTOR = [
  ...
  '#profile-bio', '#profile-display-name', '#profile-username',
