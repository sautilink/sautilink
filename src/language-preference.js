...
const SW = Object.freeze({
  ...
  'Short Videos': 'Video Fupi',
  'Personalizing posts for you…': 'Inakuchagulia posti zinazokufaa…',
  'Loading posts from people you follow…': 'Inapakia posti za watu unaowafuata…',
  'Finding short videos for you…': 'Inakutafutia video fupi…',
  'For You learns from who you follow and the posts you choose to like, save or mark as interesting.': 'Kwa Ajili Yako hujifunza kutokana na watu unaowafuata na posti unazopenda, kuhifadhi au kuonyesha kuwa zinakuvutia.',
  'Following shows the newest posts from people you follow, in time order.': 'Unafuata huonyesha posti mpya za watu unaowafuata kwa mpangilio wa muda.',
  'Short Videos brings together quick videos ranked from your follows and activity.': 'Video Fupi hukusanya video za haraka kulingana na watu unaowafuata na shughuli zako.',
  'Your For You feed is warming up.': 'Feed yako ya Kwa Ajili Yako inaanza kujifunza.',
  'Your For You feed is quiet.': 'Feed yako ya Kwa Ajili Yako iko kimya.',
  'Your Following feed is quiet.': 'Feed ya watu unaowafuata iko kimya.',
  'No short videos yet.': 'Bado hakuna video fupi.',
  'Follow people or explore public posts to help us shape this feed for you.': 'Fuata watu au chunguza posti za umma ili kutusaidia kukupangia feed hii.',
  'Follow people in Discover and their newest posts will appear here.': 'Fuata watu kwenye Discover na posti zao mpya zitaonekana hapa.',
  'New short videos from across SautiLink will appear here.': 'Video fupi mpya kutoka SautiLink zitaonekana hapa.',
  ...
  'Comments, Likes and Reposts involving your posts.': 'Maoni, kupendwa na repost zinazohusu posti zako.',
  ...
  'Commenting…': 'Inatuma maoni…',
  'Comment shared.': 'Maoni yametumwa.',
  'Comments': 'Maoni',
  'Focused comments': 'Maoni yaliyochaguliwa',
...
const FR = Object.freeze({
  ...
  'Personalizing posts for you…': 'Personnalisation des publications pour vous…',
  'Loading posts from people you follow…': 'Chargement des publications des personnes suivies…',
  'Finding short videos for you…': 'Recherche de vidéos courtes pour vous…',
  'For You learns from who you follow and the posts you choose to like, save or mark as interesting.': 'Pour vous apprend à partir des personnes que vous suivez et des publications que vous aimez, enregistrez ou marquez comme intéressantes.',
  'Following shows the newest posts from people you follow, in time order.': 'Suivi affiche les publications récentes des personnes que vous suivez, par ordre chronologique.',
  'Short Videos brings together quick videos ranked from your follows and activity.': 'Vidéos courtes rassemble des vidéos rapides classées selon vos abonnements et votre activité.',
  'Your For You feed is warming up.': 'Votre fil Pour vous commence à apprendre.',
  'Your Following feed is quiet.': 'Votre fil Suivi est calme.',
  'No short videos yet.': 'Aucune vidéo courte pour le moment.',
  'Follow people or explore public posts to help us shape this feed for you.': 'Suivez des personnes ou explorez les publications publiques pour personnaliser ce fil.',
  'Follow people in Discover and their newest posts will appear here.': 'Suivez des personnes dans Découvrir et leurs nouvelles publications apparaîtront ici.',
  'New short videos from across SautiLink will appear here.': 'Les nouvelles vidéos courtes de SautiLink apparaîtront ici.',
  ...
  'Comments, Likes and Reposts involving your posts.': 'Commentaires, mentions J’aime et republications liées à vos publications.',
  ...
  'Commenting…': 'Envoi du commentaire…',
  'Comment shared.': 'Commentaire envoyé.',
  'Comments': 'Commentaires',
  'Focused comments': 'Commentaires sélectionnés',
