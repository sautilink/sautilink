...
test('Phase 32 production build and verifier are permanent repository gates', async () => {
  ...
  for (const marker of [
    ...
    'app.js?v=20260921-notification-header2',
  ...
  assert.match(buildScript, /APP_JS_RELEASE = '20260921-notification-header2'/);
  ...
  assert.match(serviceWorker, /20260921-notification-header2/);
});
