...
test('Phase 32 production artifact targets production Supabase and removes preview copy', async () => {
  ...
  assert.match(bundle, /profile-x-ui\.css\?v=20260918-profile1/);
...
test('Phase 32 production build and verifier are permanent repository gates', async () => {
  ...
  for (const marker of [
    ...
    'app.js?v=20260917-commentmenu1',
  ...
  assert.match(buildScript, /APP_JS_RELEASE = '20260917-commentmenu1'/);
  ...
  assert.match(verifyScript, /profile-x-ui\.css\?v=20260918-profile1/);
