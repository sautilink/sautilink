...
if (!appHtml.includes('theme-init.js?v=20260904-account1')) throw new Error('staged theme bootstrap is missing');
if (!appHtml.includes('app.js?v=20260904-account1')) throw new Error('staged app JS cache marker is stale');
if (!appHtml.includes('app.css?v=20260904-account1')) throw new Error('staged app CSS cache marker is stale');
