...
if (!appHtml.includes('app.js?v=20260917-shortavatar1')) throw new Error('staged app JS cache marker is stale');
if (!appHtml.includes('app.css?v=20260917-shortavatar1')) throw new Error('staged app CSS cache marker is stale');
