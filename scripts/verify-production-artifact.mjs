...
if (!appHtml.includes('app.css?v=20260906-homehead')) throw new Error('production CSS cache marker is missing');
if (!appHtml.includes('app.js?v=20260906-homehead')) throw new Error('production JS cache marker is missing');
