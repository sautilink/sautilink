...
if (!appHtml.includes('app.css?v=20260924-short-video-routes1')) throw new Error('production CSS cache marker is missing');
if (!appHtml.includes('app.js?v=20260924-short-video-routes1')) throw new Error('production JS cache marker is missing');
if (!appHtml.includes('birthdate=20260920-birthdate1')) throw new Error('production birth date cache marker is missing');
if (!appHtml.includes('pwa.js?v=20260924-short-video-routes1')) throw new Error('production PWA cache marker is missing');
