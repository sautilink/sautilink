...
if (!appHtml.includes('app.css?v=20260904-username1')) throw new Error('production CSS cache marker is missing');
if (!appHtml.includes('app.js?v=20260904-account2')) throw new Error('production JS cache marker is missing');
