...
if (!appHtml.includes('theme-init.js?v=20260903-home1')) throw new Error('production theme bootstrap is missing');
if (!appHtml.includes('app.css?v=20260903-home1')) throw new Error('production CSS cache marker is missing');
if (!appHtml.includes('app.js?v=20260903-home1')) throw new Error('production JS cache marker is missing');
